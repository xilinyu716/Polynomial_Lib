...
int main() {
    ...
    assert(std::fabs(add_out[0] - 1.0) < 1e-6);
    assert(std::fabs(add_out[1] + 2.0) < 1e-6);
    assert(std::fabs(add_out[2] - 1.0) < 1e-6);
    int mul_len = l1 + l2 - 1;
    std::vector<double> mul_out(mul_len);
    poly_mul(p1, l1, p2, l2, mul_out.data());
    assert(mul_out.size() == 4);
    assert(std::fabs(mul_out[0] - 1.0) < 1e-6);
    assert(std::fabs(mul_out[1] + 4.0) < 1e-6);
    assert(std::fabs(mul_out[2] - 5.0) < 1e-6);
    assert(std::fabs(mul_out[3] + 2.0) < 1e-6);
    ...
    assert(rc == 0);
    assert(len_q == 2);
    assert(std::fabs(q_out[0] - 1.0) < 1e-6);
    assert(std::fabs(q_out[1] + 2.0) < 1e-6);
    assert(len_r == 1);
    ...
    assert(std::fabs(der_out[0] - 2.0) < 1e-6);
    assert(std::fabs(der_out[1] + 3.0) < 1e-6);
    ...
    assert(rc_g == 0);
    assert(len_g == 2);
    assert(std::fabs(gcd_out[0] - 1.0) < 1e-6);
    assert(std::fabs(gcd_out[1] + 1.0) < 1e-6);
